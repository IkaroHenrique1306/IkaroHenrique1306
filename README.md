![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=00F7FF&size=25&center=true&vCenter=true&width=1000&lines=Backend+Developer;C#+%7C+Java+%7C+Python;Sistemas+Inteligentes+e+Automação)
...
* Aprendizado contínuo e análise de dados complexos
* Integração de módulos experimentais de IA
* Geração de previsões e recomendações automatizadas

---

### 📦 Rastreio via WhatsApp

Sistema de automação para monitoramento de encomendas com integração via API.
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](https://mail.google.com/mail/?view=cm&fs=1&to=ikarohma07@gmail.com)
